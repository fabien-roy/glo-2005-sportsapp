...
equipment1 = Equipment(None, manufacturer_id=manufacturer1.id, category='hiking',
...
equipment2 = Equipment(None, manufacturer_id=manufacturer2.id, category='running',
...
equipment3 = Equipment(None, manufacturer_id=manufacturer3.id, category='recovery',
