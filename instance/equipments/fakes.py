...
equipment1 = Equipment(None, type_id=type1.id, type_name=type1.name,
...
equipment2 = Equipment(None, type_id=type2.id, type_name=type2.name,
...
equipment3 = Equipment(None, type_id=type3.id, type_name=type3.name,
