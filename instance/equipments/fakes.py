...
equipment1 = Equipment(None, category='hiking', name="Men Wayfinder Mid OutDry Boot",
...
equipment3 = Equipment(None, category='recovery', name="Men Molokai III Recovery Sandal",
