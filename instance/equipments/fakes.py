...
equipment1 = Equipment(None, manufacturer_name=manufacturer1.name, category='hiking',
...
equipment2 = Equipment(None, manufacturer_name=manufacturer2.name, category='running',
...
equipment3 = Equipment(None, manufacturer_name=manufacturer3.name, category='recovery',
