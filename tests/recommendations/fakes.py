...
sport2_recommendation2_user2 = Recommendation(3, sport2.id, user2.username, 'Pourri.', 0,
                                              sport2.name)
...
center1_recommendation1_user1 = Recommendation(1, center1.id, user1.username,
                                               'Un super centre. J\' adore.', 5, center1.name)
center2_recommendation1_user1 = Recommendation(2, center2.id, user1.username, 'Cool.', 3,
                                               center2.name)
center2_recommendation2_user2 = Recommendation(3, center2.id, user2.username,
...
center3_recommendation2_user1 = Recommendation(5, center3.id, user1.username, 'Noice.', 4,
                                               center3.name)
